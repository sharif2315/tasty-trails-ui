...
const NavLink: React.FC<NavLinkProps> = ({ name, href='#', icon: Icon }) => {
    return (
        <li className="min-w-52">
            <a
                href={href}
                className="group relative rounded-lg hover:bg-gray-100 px-4 py-3 text-sm text-gray-700 flex gap-4 place-items-end justify-start"
            >
                <div>
                ...
                <p className="text-md font-semibold hidden sm:block text-gray-500 group-hover:text-gray-700">{name}</p>
            </a>
        </li>
    );
};
...
const Sidebar = () => {
    return (
        <div className="hidden md:fixed md:block md:z-10">
